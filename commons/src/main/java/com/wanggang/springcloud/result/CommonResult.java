...
public class CommonResult<T> {
    ...
    public CommonResult(T data, StatusCode statusCode) {
        this.result = data;
    ...
    public CommonResult(T data, StatusCode statusCode, String extendMsg) {
        this.result = data;
        this.code = statusCode.getCode();
    ...
    public CommonResult(StatusCode statusCode, String extendMsg) {
        this.code = statusCode.getCode();
        this.message = statusCode.getMessage() + extendMsg;
        this.responseTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
    }
    ...
    public static void main(String[] args) {
        ...
        CommonResult<JSONObject> commonResult = new CommonResult<>(jsonData, StatusCode.SUCCESS);
